...
stock_db_path = os.path.join(
    r"C:\Users\amrul\PycharmProjects\stocks", "datasets", "stock.db"
)
...
if "eq_prices" not in engine.table_names():
    stock_def_tbl = Table(
        ...
        Column("px_open", Integer),
        Column("px_high", Integer),
        Column("px_low", Integer),
        Column("px_close", Integer),
        Column("volume", Integer),
        Column("px_close_after_adj", Integer),
    )
...
if "eq_returns" not in engine.table_names():
    eq_ret_tbl = Table(
        ...
        Column("ticker", String),
        Column("adate", Date),
        Column("previous_date", Date),
        Column("price", Float),
        Column("previous_price", Float),
        Column("daily_ret", Float),
    )
    meta.create_all(engine)
