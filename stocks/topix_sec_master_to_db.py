...
topix_en_df = pd.read_excel(
    os.path.join(
        r"C:\Users\amrul\PycharmProjects\stocks", "datasets", "TOPIX_weight_en.xlsx"
    ),
    dtype={"Code": str},
)
topix_jp_df = pd.read_excel(
    os.path.join(
        r"C:\Users\amrul\PycharmProjects\stocks", "datasets", "TOPIX_weight_jp.xlsx"
    ),
    dtype={"コード": str},
)
...
en_cols = [
    ...
    "Code",
    "Sector",
    "Component Weight (TOPIX)",
    "New Index Series Code",
    "Issue to which the liquidity factor is applied",
]
jp_cols = [
    "日付",
    "銘柄名",
...
rename_cols = {
    ...
    "Sector": "industry_en",
    "業種": "industry_jp",
    "Component Weight (TOPIX)": "component_weight",
    "New Index Series Code": "new_index_series_code_en",
...
db_cols = [
    ...
    "industry_en",
    "industry_jp",
    "new_index_series_code_en",
    "new_index_series_code_jp",
    "component_weight",
]
...
topix_mrg2_df[db_cols].to_sql(
    "eq_sec_master", engine, index=False, if_exists="append", dtype=dtype_dict
)
